...
interface ClientMediaUploadProps {
  clientId: string;
  onUploadComplete: () => void;
}

const ClientMediaUpload = ({ clientId, onUploadComplete }: ClientMediaUploadProps) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your media has been saved successfully.",
      });
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="e.g., Forehand technique"
            />
          </div>
